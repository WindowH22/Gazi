...
public class OpenApiServiceImpl implements OpenApiService {
    ...
    public JSONArray getJsonArray() throws IOException {
        ...
        System.out.println("OpenAPi: Response code: " + conn.getResponseCode()); /* 연결 자체에 대한 확인이 필요하므로 추가합니다.*/
        BufferedReader rd;
        ...
        JSONArray result = accInfo.getJSONArray("row");
